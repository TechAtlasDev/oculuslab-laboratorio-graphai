...
### `GET /api/v1/analysis/repurpose/disease/{disease_id}`
**Resumen:** Disease Repurposing Analysis

| Parámetro | Ubicación | Tipo | Requerido | Descripción |
| :--- | :--- | :--- | :--- | :--- |
| `disease_id` | `path` | `string` | ✅ | ID of the disease to analyze (e.g. MONDO:0001) |
| `limit` | `query` | `integer` | ❌ | - |
